...
model_name = "/public/home/tt/Llama/Meta-Llama-3-8B-Instruct"  # Path of the pretrained model downloaded from Hugging Face
new_model_dir = f"saved_models/test/train_{len(train_df)}_lr{learning_rate}_bs{per_device_train_batch_size}"  # Fine-tuned model name
